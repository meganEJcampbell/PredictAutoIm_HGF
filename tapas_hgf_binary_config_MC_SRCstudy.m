function c = tapas_hgf_binary_config_MC_SRCstudy
%%%%% MEJC adjusted as per Mathys' advice from github
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% c.ommu = [NaN,  -3,  -6];
% c.omsa = [NaN, 4^2, 4^2];
% but this gives error in vairational approx -> parameters violate model assumptions to on advice from Mathys use these values
% instead
c.ommu = [NaN, -4, -2]; 
c.omsa = [NaN, 1, 1] ;
